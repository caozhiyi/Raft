...
class StreamSettings : public ::google::protobuf::Message {
 public:
  ...
  inline bool has_need_feedback() const;
  inline void clear_need_feedback();
  static const int kNeedFeedbackFieldNumber = 2;
  inline bool need_feedback() const;
  inline void set_need_feedback(bool value);
...
class StreamFrameMeta : public ::google::protobuf::Message {
 public:
  StreamFrameMeta();
  ...
  inline bool has_source_stream_id() const;
  inline void clear_source_stream_id();
  static const int kSourceStreamIdFieldNumber = 2;
  inline ::google::protobuf::int64 source_stream_id() const;
  inline void set_source_stream_id(::google::protobuf::int64 value);
  ...
  inline ::brpc::FrameType frame_type() const;
  inline void set_frame_type(::brpc::FrameType value);

  // optional bool has_continuation = 4;
  inline bool has_has_continuation() const;
  inline void clear_has_continuation();
  static const int kHasContinuationFieldNumber = 4;
  inline bool has_continuation() const;
  inline void set_has_continuation(bool value);
  ...
  inline const ::brpc::Feedback& feedback() const;
  inline ::brpc::Feedback* mutable_feedback();
  inline ::brpc::Feedback* release_feedback();
  inline void set_allocated_feedback(::brpc::Feedback* feedback);
...
class Feedback : public ::google::protobuf::Message {
 public:
  ...
  inline void clear_consumed_size();
  static const int kConsumedSizeFieldNumber = 1;
  inline ::google::protobuf::int64 consumed_size() const;
  inline void set_consumed_size(::google::protobuf::int64 value);
...
inline ::brpc::Feedback* StreamFrameMeta::mutable_feedback() {
  set_has_feedback();
  if (feedback_ == NULL) feedback_ = new ::brpc::Feedback;
  return feedback_;
}
