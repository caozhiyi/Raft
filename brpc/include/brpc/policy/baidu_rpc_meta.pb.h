...
class RpcMeta : public ::google::protobuf::Message {
 public:
  ...
  inline void set_allocated_request(::brpc::policy::RpcRequestMeta* request);
  ...
  inline void set_allocated_response(::brpc::policy::RpcResponseMeta* response);
  ...
  inline void set_allocated_chunk_info(::brpc::ChunkInfo* chunk_info);
  ...
  inline bool has_stream_settings() const;
  inline void clear_stream_settings();
  static const int kStreamSettingsFieldNumber = 8;
  inline const ::brpc::StreamSettings& stream_settings() const;
  inline ::brpc::StreamSettings* mutable_stream_settings();
  inline ::brpc::StreamSettings* release_stream_settings();
  inline void set_allocated_stream_settings(::brpc::StreamSettings* stream_settings);
...
inline ::brpc::StreamSettings* RpcMeta::mutable_stream_settings() {
  ...
  if (stream_settings_ == NULL) stream_settings_ = new ::brpc::StreamSettings;
