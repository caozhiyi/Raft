...
class HelloResquest : public ::google::protobuf::Message {
 public:
  HelloResquest();
  virtual ~HelloResquest();

  HelloResquest(const HelloResquest& from);

  inline HelloResquest& operator=(const HelloResquest& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const HelloResquest& default_instance();

  void Swap(HelloResquest* other);

  // implements Message ----------------------------------------------

  HelloResquest* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const HelloResquest& from);
  void MergeFrom(const HelloResquest& from);
  void Clear();
  bool IsInitialized() const;
  ...
  // @@protoc_insertion_point(class_scope:raft.HelloResquest)
 private:
  ...
  void InitAsDefaultInstance();
  static HelloResquest* default_instance_;
};
// -------------------------------------------------------------------
...
class HelloResponse : public ::google::protobuf::Message {
 public:
  ...
  // @@protoc_insertion_point(class_scope:raft.HelloResponse)
 private:
...
class RaftService_Stub : public RaftService {
 public:
  ...
  void client_msg(::google::protobuf::RpcController* controller,
                       ...
                       ::raft::ClientResponse* response,
                       ::google::protobuf::Closure* done);
  void rpc_hello(::google::protobuf::RpcController* controller,
                       const ::raft::HelloResquest* request,
                       ::raft::HelloResponse* response,
                       ::google::protobuf::Closure* done);
 private:
